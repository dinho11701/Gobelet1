                ...
                then do 
                    if estCasDrop [x2,y2] 
                        then do 
                            ...
                            let bonOrdre = piecePrisDansBonOrdre joueur tt (ListesDispo "" listeBU listeMU listeSU listeTU listeBO listeMO listeSO listeTO)
                            ...
                            if bonOrdre == "oui"
                                ...
                                putStrLn "cest pas un ordre resprcté recommence"
